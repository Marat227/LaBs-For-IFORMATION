										...
										template<typename T="">
											...
											Node<T>
												*root;
												...
												void recursivePreOrder(const Node<T>
													*) const;
													void recursiveInOrder(const Node<T>
														*) const;
														void recursivePostOrder(const Node<T>
															*) const;
															int recursiveCountNodes(const Node<T>
																*) const;
																int recursiveCountLeafNodes(const Node<T>
																	*) const;
																	int recursiveComputeHeightOfTree(const Node<T>
																		*) const;
																		void recursiveDeleteNodes(const Node<T>
																			*);
																			void recursiveDraw(Node<T>
																				*node);
																				Node<T>
																					* getLeftmostNode(Node<T>
																						*node) const;
																						int getNodeLevel(Node<T>
																							*node);
																							int getPxLocOfLeftTree(const Node<T>
																								*node);
																								int getPxLocOfAncestor(const Node<T>
																									*node);
																									void resetNodePosition(Node<T>
																										*node);
																										bool recursiveDeleteAtLocation(Node<T>
																											*node, int x, int y);
																											};
																											...
																											template<typename T="">
																												Node<T>
																													...
																													template<typename T="">
																														int BinarySearchTree<T>
																															::max(int a, int b) const
																															{
																															return a > b ? a : b;
																															}
																																		...
																																		BinarySearchTree<T>
																																			...
																																			template<typename T="">
																																				bool BinarySearchTree<T>
																																					::recursiveDeleteAtLocation(Node<T>
																																						*node, int x, int y)
																																						{
																																						if (node == 0)
																																						return false;
...
template<typename T="">
    ...
    if (currentNode->leftChild == 0 && currentNode->rightChild != 0)
        ...
        {
            Node<T>
																																																																				*tempPtr = trailCurrentNode->rightChild;
																																																																				...
																																																																				{
																																																																				Node<T>
																																																																					*tempPtr = trailCurrentNode->leftChild;
																																																																								...
																																																																								*tempPtr = trailCurrentNode->leftChild;
																																																																								...
																																																																								Node<T>
																																																																									*ptr = currentNode;
																																																																									...
																																																																									template<typename T="">
																																																																										QString BinarySearchTree<T>
																																																																											::getFindElement(T item) const
																																																																											{
																																																																											if (this->isEmpty())
																																																																											return QString("");
...
template<typename T="">
																																																																																	void BinarySearchTree<T>
																																																																																		::recursivePreOrder(const Node<T>
																																																																																			*node) const
																																																																																			{
																																																																																			if (node == 0)
																																																																																			return;
...
template<typename T="">
																																																																																							void BinarySearchTree<T>
																																																																																								::recursivePostOrder(const Node<T>
																																																																																									*node) const
																																																																																									{
																																																																																									if (node == 0)
																																																																																									return;
																																																																																																										...
																																																																																																										*traverse;
																																																																																																										...
																																																																																																										QQueue<Node<T>
																																																																																																											*> ptrQueue;
																																																																																																											...
																																																																																																											template<typename T="">
																																																																																																												int BinarySearchTree<T>
																																																																																																													::recursiveCountNodes(const Node<T>
																																																																																																														*node) const
																																																																																																														{
																																																																																																														if (node == 0)
																																																																																																														return 0;
																																																																																																														...
																																																																																																														template<typename T="">
																																																																																																															int BinarySearchTree<T>
																																																																																																																::recursiveCountLeafNodes(const Node<T>
																																																																																																																	*node) const
																																																																																																																	{
																																																																																																																	if (node == 0)
																																																																																																																	return 0;
																																																																																																																	...
																																																																																																																	template<typename T="">
																																																																																																																		int BinarySearchTree<T>
																																																																																																																			::recursiveComputeHeightOfTree(const Node<T>
																																																																																																																				*node) const
																																																																																																																				{
																																																																																																																				...
																																																																																																																				template<typename T="">
																																																																																																																					void BinarySearchTree<T>
																																																																																																																						::recursiveDeleteNodes(const Node<T>
																																																																																																																							*node)
																																																																																																																							{
																																																																																																																							if (node == 0)
																																																																																																																							return;
																																																																																																																								...
																																																																																																																								void BinarySearchTree<T>
																																																																																																																									::resetNodePosition(Node<T>
																																																																																																																										*node)
																																																																																																																										...
																																																																																																																										template<typename T="">
																																																																																																																											void BinarySearchTree<T>
																																																																																																																												::draw(QPainter *painter, double &scale)
																																																																																																																												{
																																																																																																																												if(this->root == 0)
																																																																																																																												return;
																																																																																																																																				...
																																																																																																																																				*node)
																																																																																																																																				...
																																																																																																																																				Node<T>
																																																																																																																																					*current = node;
																																																																																																																																					...
																																																																																																																																					template<typename T="">
																																																																																																																																						int BinarySearchTree<T>
																																																																																																																																							::getPxLocOfLeftTree(const Node<T>
																																																																																																																																								*node)
																																																																																																																																								{
																																																																																																																																								...
																																																																																																																																								template<typename T="">
																																																																																																																																									int BinarySearchTree<T>
																																																																																																																																										::getPxLocOfAncestor(const Node<T>
																																																																																																																																											*node)
																																																																																																																																											{
																																																																																																																																											Node<T>
